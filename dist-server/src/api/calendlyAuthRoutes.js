...
const calendlyAuthRouter = Router();
...
calendlyAuthRouter.get('/', (req, res) => {
...
calendlyAuthRouter.post('/callback', async (req, res, next) => {
...
calendlyAuthRouter.post('/disconnect', async (req, res, next) => {
...
calendlyAuthRouter.post('/refresh', async (req, res, next) => {
...
//# sourceMappingURL=calendlyAuthRoutes.js.map